package basement.annotation;

import java.lang.reflect.InvocationHandler;
import java.lang.reflect.Method;

import basement.annotation.imp.AOPMethod;
...
public class AOPHandle implements InvocationHandler {
   ...
   * @param Object[] args	方法参数 不能使用invoke时使用proxy作为反射参数时,因为代理对象的接口,不同于对象 这种代理机制是面向接口，而不是面向类的
   **/
  @Override
